...
\begin{mdframed}[backgroundcolor=findingbox,
                 ...
                 linewidth=1.5pt]
\textbf{HOW THIS FINDING WAS DERIVED ---
READ THIS FIRST:}
...
(GSE176078), FOXA1 and EZH2 were identified
as mechanistic opposites on the primary
identity axis of breast cancer. The predicted
subtype ordering --- LumA $>$ LumB $>$ HER2
$>$ TNBC $>$ Claudin-low --- was
\textbf{locked in a timestamped document
before any confirmatory dataset was analysed}.
The prediction was then tested in seven
independent datasets. It confirmed exactly,
in the predicted direction, across all seven.

The statistics in this document are
\textbf{confirmations of a pre-specified
prediction}. They are not the source of it.
...
computed from two standard IHC stains, correctly
orders all six major breast cancer subtypes and
maps each to its therapeutic treatment logic.
Computationally validated across ${\sim}7{,}500$
patients in seven independent datasets on four
measurement platforms. Zero biological
contradictions.
