...
PD, Essential Tremor, Huntington's disease, ALS, and Dystonia. Anle138b
is identified as a universal Tier~2 cross-entry compound for all \Lev{1}
propagating protein Hub entries simultaneously. Four novel predictions
locked 2026-03-09.
\end{abstract}
...
\begin{description}[leftmargin=2em, itemsep=0.5em]
  ...
  \item[\textbf{DBS:}] Clinically successful because it delivers a \Lev{3}
    ...
    \Lev{1} cellular identity failure. The combination trial (DBS + \Lev{1}
