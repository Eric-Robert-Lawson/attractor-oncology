...
The complete theoretical derivation, literature
confirmation against five independent sources,
and the full experimental prediction set (P7--P11)
are given in the linked theory paper:
\href{https://doi.org/10.5281/zenodo.19094935}
{\texttt{doi:10.5281/zenodo.19094935}}.
...
Total per cohort: \$25,000--\$45,000
(3 conditions).
...
experimental series. The following records
existed at the time of this deposit and are
cited here with confirmed DOIs.
No forward references to undeposited documents
are included.
...
are reported in all publications arising
